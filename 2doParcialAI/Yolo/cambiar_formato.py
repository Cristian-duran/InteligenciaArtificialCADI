...
rgba_images_path = f"D:\Ayuda Python\Tipo_fideos_cop\Fideo corbata"

# Ruta donde deseas guardar las imágenes RGB
output_path = "D:/Ayuda Python/Corregidos"

if not os.path.exists(output_path):
    os.makedirs(output_path)

for filename in os.listdir(rgba_images_path):
    if filename.lower().endswith((".png", ".jpeg", ".jpg", ".gif", ".GIF", ".webp")):
